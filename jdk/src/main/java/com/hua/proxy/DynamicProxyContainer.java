/**
  * @filename DynamicProxyContainer.java
  * @description 
  * @version 1.0
  * @author qianye.zheng
 */
...
/**
 * @type DynamicProxyContainer
 * @description 动态代理
 * @author qianye.zheng
 */
public final class DynamicProxyContainer {
	/**
	 * 静态代理
	 * 1) 定义一个接口、对应的实现类
	 ...
	 * @author qianye.zheng
	 */
	public static final class Cinema implements InvocationHandler {
		//private Movie delegate; // 方式1
		private Object delegate; // 方式2
