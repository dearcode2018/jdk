...
import com.hua.entity.ProductUnqualified;
 ...
 * FieldCheckTest
 */
public final class FieldCheckTest extends BaseTest {
	...
	public void testFieldCheck() {
		try {
			...
			productUnqualified.setIcOrgId("afalksjdf");
